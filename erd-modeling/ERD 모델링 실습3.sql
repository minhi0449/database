...
insert into `Users` (`userId`,`userName`,`userBirth`,`userGender`,`userHp`,`userEmail`,`userPoint`,`userLevel`,`userAddr`,`userRegDate`) values ('user8','신사임당','1965-10-21','M','010-5101-1965','sinsa@gmail.comm',1500,1,'대구','2022-01-10 10:50:12');
insert into `Users` (`userId`,`userName`,`userBirth`,`userGender`,`userHp`,`userEmail`,`userPoint`,`userLevel`,`userAddr`,`userRegDate`) values ('user9','이이','1972-11-28','F','010-6101-1972','leelee@nate.com',1500,3,'부산','2022-01-10 10:50:12');
insert into `Users` (`userId`,`userName`,`userBirth`,`userGender`,`userHp`,`userPoint`,`userLevel`,`userAddr`,`userRegDate`) values ('user10','허난설헌','1992-09-07','F','010-7103-1992',1200,3,'광주','2022-01-10 10:50:12');
...
insert into `Points` (`userId`,`point`,`pointDesc`,`pointDate`) values ('user7',2000,'이벤트 응모 2000 적립','2022-01-10 10:50:12');
...
insert into `Products` (`prodNo`,`cateNo`,`sellerNo`,`prodName`,`prodStock`,`prodPrice`,`prodSold`,`prodDiscount`) values (100110, 10, 10004, '트레이닝 통바지', 1602, 38000, 132, 20);
insert into `Products` (`prodNo`,`cateNo`,`sellerNo`,`prodName`,`prodStock`,`prodPrice`,`prodSold`,`prodDiscount`)  values (110101, 10, 10003, '신상 여성운동화', 160, 76000, 132, 20);
insert into `Products` (`prodNo`,`cateNo`,`sellerNo`,`prodName`,`prodPrice`,`prodSold`,`prodDiscount`)  values (120101, 12, 10010, '암소 1등급 구이셋트 1.2kg', 150000, 132, 20);
insert into `Products` (`prodNo`,`cateNo`,`sellerNo`,`prodName`,`prodPrice`,`prodSold`,`prodDiscount`)  values (120103, 12, 10010, '바로구이 부채살 250g', 21000, 132, 20);
insert into `Products` (`prodNo`,`cateNo`,`sellerNo`,`prodName`,`prodStock`,`prodPrice`,`prodSold`,`prodDiscount`)  values (130101, 13, 10006, '[ANF] 식스프리 강아지 사료', 58, 56000, 132, 20);
insert into `Products` (`prodNo`,`cateNo`,`sellerNo`,`prodName`,`prodStock`,`prodPrice`,`prodSold`,`prodDiscount`)  values (130112, 13, 10006, '중대형 사계절 강아지옷', 120, 15000, 132, 20);
insert into `Products` (`prodNo`,`cateNo`,`sellerNo`,`prodName`,`prodPrice`,`prodSold`,`prodDiscount`)  values (141001, 14, 10001, '라떼 2인 소파/방수 패브릭', 320000, 132, 20);
insert into `Products` (`prodNo`,`cateNo`,`sellerNo`,`prodName`,`prodStock`,`prodPrice`,`prodSold`,`prodDiscount`)  values (170115, 17, 10007, '지포스 3080 그래픽카드', 28, 900000, 132, 20);
insert into `Products` (`prodNo`,`cateNo`,`sellerNo`,`prodName`,`prodStock`,`prodPrice`,`prodSold`,`prodDiscount`)  values (160103, 16, 10009, '치닝디핑 33BR 철봉', 32, 120000, 132, 20);
...
# https://quantpro.co.kr/mysql-%EC%97%90%EB%9F%AC%ED%95%B4%EA%B2%B0-sql-error-1452-sqlstate-23000-%EC%97%90%EB%9F%AC%EB%B0%9C%EC%83%9D/
...
# 문제5. 모든 주문의 주문번호, 주문자 아이디, 고객명, 상품명, 주문일자를 조회하시오. 주문번호는 중복 없는 상품명은 구분자 ,로 나열할것
...
# 문제9. 모든 주문상세내역 중 개별 상품 가격과 개수 그리고 할인율이 적용된 가격을 구하고 그 가격으로 주문별 총합을 구해서 주문별 총합이 10만원이상 그리고 큰 금액 순으로 `주문번호`, `최종총합`을회하시오. 
